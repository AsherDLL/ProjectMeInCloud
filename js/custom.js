...
function initialize() {
    var mapOptions = {
      zoom: 16,
      center: new google.maps.LatLng(19.019186, -98.243560),
      scrollwheel: false
    };
...
function loadGoogleMap(){
    ...
    script.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDiecY8DpIpWWBrp6Nz_rhjbByWV6gNEVM&v=3.exp&sensor=false&' + 'callback=initialize';
